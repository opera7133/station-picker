const korailStations = {
  ...
  "korail-jeolla": [
    ...
    { name: "新飛鳳", en: "Sinbibong", orig: "신비봉역", id: "sinbibong" },
  ...
  "korail-janghang": [
    ...
    { name: "艮峙", en: "Ganchi", orig: "간치역", id: "ganchi" },
  ...
  "korail-gyeongjeon": [
    ...
    { name: "龍岡", en: "Yonggang", orig: "용강역", id: "yonggang" },
    ...
    { name: "横川", en: "Hwengcheon", orig: "횡천역", id: "hwengcheon" },
    { name: "河東", en: "Hadong", orig: "하동역", id: "hadong" },
    { name: "津上", en: "Jinsang", orig: "진상역", id: "jinsang" },
    { name: "玉谷", en: "Okgok", orig: "옥곡역", id: "okgok" },
    { name: "骨薬", en: "Golyak", orig: "골약역", id: "golyak" },
    { name: "光陽", en: "Gwangyang", orig: "광양역", id: "gwangyang" },
    { name: "平和", en: "Pyeonghwa", orig: "평화역", id: "pyeonghwa" },
    { name: "順天", en: "Suncheon", orig: "순천역", id: "suncheon" },
    { name: "元昌", en: "Wonchang", orig: "원창역", id: "wonchang" },
    ...
    { name: "広谷", en: "Gwang-gok", orig: "광곡역", id: "gwang-gok" },
  ...
  "korail-gyeongbuk": [
    ...
    { name: "青里", en: "Cheongni", orig: "청리역", id: "cheongni" },
  ...
  "korail-daegu": [
    ...
    { name: "鳳亭", en: "Bongjeong", orig: "봉정역", id: "bongjeong" },
    {
      name: "北永川",
      en: "Bugyeongcheon",
      orig: "북영천역",
  ...
  "korail-samcheok": [
    ...
    { name: "湫岩", en: "Chuam", orig: "추암역", id: "chuam" },
    {
      name: "三陟海辺",
      en: "Samcheokhaebyeon",
      orig: "삼척해변역",
  ...
  "korail-jungbu-naeryuk": [
    ...
    { name: "牙美", en: "Ami", orig: "아미역", id: "ami" },
    { name: "牙谷", en: "Agok", orig: "아곡역", id: "agok" },
    ...
    { name: "金加", en: "Geumga", orig: "금가역", id: "geumga" },
    { name: "忠州", en: "Chungju", orig: "충주역", id: "chungju" },
    { name: "サルミ", en: "Salmi", orig: "살미역", id: "salmi" },
    {
      name: "水安堡温泉",
      en: "Suanbooncheon",
      orig: "수안보온천역",
  ...
  "korail-taebaek": [
    ...
    { name: "炭扶", en: "Tanbu", orig: "탄부역", id: "tanbu" },
    { name: "蓮下", en: "Yeonha", orig: "연하역", id: "yeonha" },
    { name: "石項", en: "Seokhang", orig: "석항역", id: "seokhang" },
    { name: "礼美", en: "Yemi", orig: "예미역", id: "yemi" },
    { name: "鳥洞", en: "Jodong", orig: "조동역", id: "jodong" },
    { name: "紫味院", en: "Jamiwon", orig: "자미원역", id: "jamiwon" },
    { name: "民東山", en: "Mindungsan", orig: "민둥산역", id: "mindungsan" },
  ...
  "korail-jeongseon": [
    { name: "民東山", en: "Mindungsan", orig: "민둥산역", id: "mindungsan" },
    { name: "別於谷", en: "Byeoleogok", orig: "별어곡역", id: "byeoleogok" },
    ...
    { name: "阿烏拉吉", en: "Auraji", orig: "아우라지역", id: "auraji" },
  ...
  "korail-yeongdong": [
    ...
    { name: "文殊", en: "Munsu", orig: "문수역", id: "munsu" },
    { name: "甕泉", en: "Ongcheon", orig: "옹천역", id: "ongcheon" },
    ...
    { name: "古士里", en: "Gosari", orig: "고사리역", id: "gosari" },
    { name: "次口", en: "Chagu", orig: "차구역", id: "chagu" },
    { name: "新基", en: "Singi", orig: "신기역", id: "singi" },
    { name: "上鼎", en: "Sangjeong", orig: "상정역", id: "sangjeong" },
    { name: "未老", en: "Miro", orig: "미로역", id: "miro" },
    { name: "桃京里", en: "Dogyeong-ri", orig: "도경리역", id: "dogyeong-ri" },
    { name: "東海", en: "Donghae", orig: "동해역", id: "donghae" },
