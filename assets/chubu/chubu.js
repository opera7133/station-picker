      ...
      railway: [
        {
          name: "本線",
          id: "honsen",
          icon: "assets/chubu/chitetsu/honsen.svg",
        },
        {
          name: "立山線",
          id: "tateyama",
          icon: "assets/chubu/chitetsu/tateyama.svg",
        },
        {
          name: "不二越線",
          id: "fujikoshi",
          icon: "assets/chubu/chitetsu/fujikoshi.svg",
        },
        {
          name: "上滝線",
          id: "kamidaki",
        ...
        },
        {
          name: "1系統",
          id: "1",
          icon: "assets/chubu/chitetsu/1.svg",
        },
        {
          name: "2系統",
          id: "2",
          icon: "assets/chubu/chitetsu/2.svg",
        },
        {
          name: "3系統",
          id: "3",
          icon: "assets/chubu/chitetsu/3.svg",
        },
        {
          name: "4系統",
          id: "4",
          icon: "assets/chubu/chitetsu/4.svg",
        },
        {
          name: "5系統",
          id: "5",
          icon: "assets/chubu/chitetsu/5.svg",
        },
        {
          name: "6系統",
          id: "6",
          icon: "assets/chubu/chitetsu/6.svg",
        },
      ],
    },
    manyo: {
